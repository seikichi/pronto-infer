...
require 'pronto/infer/version'

Gem::Specification.new do |spec|
  spec.name          = 'pronto-infer'
  spec.version       = Pronto::InferVersion::VERSION
  spec.authors       = ['Seiichi KONDO']
  spec.email         = ['seikichi@kmc.gr.jp']

  spec.summary       = 'Pronto runner for infer'
  spec.description   = <<-DESCRIPTION
    A pronto runner for infer.
  ...
  DESCRIPTION
  spec.homepage      = 'https://github.com/seikichi/pronto-infer'
  spec.license       = 'MIT'
